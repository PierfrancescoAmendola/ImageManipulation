...
if __name__ == '__main__':
    ...
    writer = SummaryWriter('runs/SuiteTest_1_ResNet34/' + str_log,
                           comment=f"{str_log} batch_{batch_size} lr_{lr} epoch{epochNumber} Fold_{fold}")

    # 6. DEFINIZIONE MODELLO (ResNet34)
    print("Caricamento modello ResNet34...")
    net = torchvision.models.resnet34(weights='IMAGENET1K_V1')

    # Modifica dell'ultimo layer per CIFAR-10 (10 classi)
